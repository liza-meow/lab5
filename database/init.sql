...
CREATE TABLE materials (
  name char(12) NOT NULL default '' PRIMARY KEY,
...
CREATE TABLE loadings (
  ...
  key_node smallint REFERENCES nodes(id) ON DELETE CASCADE
);
...
CREATE TABLE elements (
  id serial NOT NULL,
  n1 smallint NOT NULL REFERENCES nodes(id) ON DELETE CASCADE,
  n2 smallint NOT NULL REFERENCES nodes(id) ON DELETE CASCADE,
  n3 smallint NOT NULL REFERENCES nodes(id) ON DELETE CASCADE,
